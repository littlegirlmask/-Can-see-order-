	...
	<div class="row-fluid">
		<div class="span12">
			<form class="form-horizontal form-inline"
				action="${pageContext.request.contextPath}/goods/edit"
					...
					<div class="controls">
						<select id="gtid" name="gtid">
							<c:forEach items="${type}" var="item">
								<option value="${item.gtid}"
								<c:if test="${item.gtid==goods.gtid}">selected="selected"</c:if>
								>${item.gtname}</option>
							</c:forEach>
						</select>
					</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="gname" type="text" value="${goods.gname}" name="gname" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-group">
					      <input type="number" step="0.01" class="form-control" value="${goods.gprice}" name="gprice" id="gprice" placeholder="￥0.00">
					    </div>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="form-control" name="gcontent" rows="5" style="width:283px;resize:none">${goods.gcontent}</textarea>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-group">
					      <input type="number" step="0.01" class="form-control"  value="${goods.gtime}" name="gtime" id="gtime" placeholder="小时数（可精确到小数点后两位）">分钟
					    </div>
					</div>
				</div>
				<div class="control-group">
